...
class RemoteConsole {
  RemoteConsole(LspServer connection) {
    _connection = connection;
  }

  late LspServer _connection;
  ...
  /// Ask the client to log a debug message.
  /// Available since version 3.18.0 of the LSP specification.
